        ...
        if(checkNetworkConnection(context)){
            ...
            while(cur.moveToNext()){
                ...
                if(sync_status == dataBaseHelper.SYNC_STATUS_FAILED){
                    final String barcode_id = cur.getString(cur.getColumnIndex(dataBaseHelper.COLUMN_B_BARCODEID));
                                ...
                                public void onResponse(String response) {
                                    try {
                                        ...
                                        if(Response.equals("Sync Successful")){
                                            dataBaseHelper.updateLocalDatabase(barcode_id, dataBaseHelper.SYNC_STATUS_OK);
